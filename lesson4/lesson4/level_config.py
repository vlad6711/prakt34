...
level_2.add_enemy(0, 650, 100, 500, 800, 4)
level_2.add_enemy(1, 1150, 100, 1000, 1400, 6)
level_2.add_enemy(1, 2200, 100, 2100, 2400, 6)
level_2.add_enemy(0, 2650, 100, 2500, 2800, 4)

level_2.add_platform(0, 550, 300, 100, 15, 0, 0)
level_2.add_platform(500, 400, 300, 100, 10, 0, 0)
level_2.add_platform(1000, 450, 300, 100, 15, 0, 0)
level_2.add_platform(1500, 350, 300, 50, 5, 0, 0)
level_2.add_platform(2000, 450, 300, 100, 15, 0, 0)
level_2.add_platform(2500, 350, 200, 50, 10, 0, 0)


level_2.set_goal(3100, 300)
